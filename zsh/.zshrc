...
export PATH="/opt/homebrew/bin:/opt/homebrew/sbin:/Users/johnny/Library/Python/3.9/bin:/usr/local/opt/libpq/bin:$SCRIPTS:$BUN_INSTALL/bin/:$HOME/bin:/usr/local/bin:$PATH"
